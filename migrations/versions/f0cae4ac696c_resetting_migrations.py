...
Revision ID: f0cae4ac696c
Revises: 4940170afef1
Create Date: 2025-07-14 10:37:47.860036
...
revision = 'f0cae4ac696c'
down_revision = '4940170afef1'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('tf_active', sa.Boolean(), nullable=True),
    sa.Column('is_tf_complete', sa.Boolean(), nullable=True),
    sa.Column('last_tf', sa.DateTime(), nullable=True),
    sa.Column('last_password_renewal', sa.DateTime(), nullable=True),
